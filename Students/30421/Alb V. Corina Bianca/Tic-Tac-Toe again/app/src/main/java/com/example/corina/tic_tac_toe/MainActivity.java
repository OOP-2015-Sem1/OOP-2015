...
public class MainActivity extends Activity {
    ...
    private int mScorePlayerO;
    private int mScorePlayerX;
    ...
    private void calculate() {
        Log.e("TAG","calculate");
        FindGameWinner whether = new FindGameWinner(somebodyWon, mButtons);
        String result = whether.gameWinner();
        somebodyWon = whether.getSomebodyWon();
        if (result.equals("O")) {
