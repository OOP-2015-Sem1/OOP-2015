...
% RAB  small changes from dspblkbfftscope2.m 
...
% Last Modified by : Arvind Sundararajan
% Modification Date : 28 March 2006
% Reason : CRXXXXXX : The model fails to simulate in Matlab2006
...
case 'icon'
    ...
    if ~strcmp(domain,'Frequency'),
        error('Invalid domain for Xfer Scope');
    end
    x = [0 NaN 100 NaN ...
            8  8  92  92 8 NaN]; 
    ...
    y = [0  NaN 100 NaN ...
            92 40 40  92 92 NaN];
    % gen a smooth curve that fits in the box.
    xp=1:.1:11;
    y=[y,30*log10(10*(xp.^2)./(100+xp.^4))+90];
    x=[x,8*(xp)];
