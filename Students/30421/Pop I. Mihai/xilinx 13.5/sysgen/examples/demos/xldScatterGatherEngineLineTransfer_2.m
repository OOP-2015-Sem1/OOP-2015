function [ arready, rvalid, rlast, rdata, rresp ] = xlScatterGatherEngineLineTransfer_2( ...
    araddr, arlen, arsize, arburst,arprot, arcache, arvalid,...
    rready, rx_rows, rx_cols)  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%Setting Up the Descriptor Memory 
...
START_ADDRESS = (READING_ROWS*READING_COLS*4) +DELAY;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% persistent swathe_number, swathe_number = xl_state(0, {xlUnsigned, 12, 0});
