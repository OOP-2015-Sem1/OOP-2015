%
% Filename   : ML402_NetEth_PostGeneration.m
%
% Description: Defines the post-generation function for the
%              Ethernet co-simulation compilation.
%

function status = ML402_NetEth_PostGeneration(target_params)
    ...
    target_params.non_memory_mapped_ports = ML402_NetEth_NonMmPorts;

    % Co-simulation information.
    target_params.cosim_params = ML402_NetEth_CosimTable;
