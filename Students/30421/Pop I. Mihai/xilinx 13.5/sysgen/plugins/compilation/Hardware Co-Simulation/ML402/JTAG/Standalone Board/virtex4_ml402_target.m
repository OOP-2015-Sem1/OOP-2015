%
% Filename:    virtex4_ml402_target.m
%
% Description: This file defines the supported and default compilation
%              settings for the Virtex4 ML402
%

function settings = virtex4_ml402_target
  ...
  settings.('postgeneration_fcn') = 'virtex4_ml402_postgeneration';
