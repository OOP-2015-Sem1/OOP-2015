%
% Filename   : S3ADSP_DB_NetEth_PostGeneration.m
%
% Description: Defines the post-generation function for the
%              Ethernet co-simulation compilation.
%

function status = S3ADSP_DB_NetEth_PostGeneration(target_params)
    ...
    target_params.non_memory_mapped_ports = S3ADSP_DB_NetEth_NonMmPorts;

    % Co-simulation information.
    target_params.cosim_params = S3ADSP_DB_NetEth_CosimTable;
