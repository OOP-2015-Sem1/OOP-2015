%
% Filename:    S3ADSP_DB_JTAG_Target.m
%
% Description: This file defines the supported and default compilation
%              settings for the Spartan-3A DSP 3400A Development Platform (JTAG)
%

function settings = S3ADSP_DB_JTAG_Target
  ...
  settings.('postgeneration_fcn') = 'S3ADSP_DB_JTAG_PostGeneration';
