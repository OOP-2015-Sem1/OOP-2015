...
#  /___/  \  /   Vendor: Xilinx
#  \   \   \/    Version: 2.0
#   \   \        Filename: fir_compiler_v3_2_v2_0_utils.tcl
...
namespace eval fir_compiler_v3_2_v2_0_utils {
   ...
   proc log2int { value } {
     ...
     set abc1 [ fir_compiler_v3_2_v2_0_utils::log2 $value ]
   ...
   proc get_data_mem_type { mem_option data_mem_space num_channels srl16_depth_thres coef_struct filt_type rate_type data_buff_type } {
     ...
     if { $mem_option == "Automatic" } {
       ...
       #set temp_val [ expr { $num_channels * pow(2, [fir_compiler_v3_2_v2_0_utils::log2ceil  $data_mem_space  ]) } ]
   ...
   proc get_coef_mem_type { mem_option coef_mem_space num_filts coef_reload dram_depth_thres srl16_depth_thres coef_buff_type } {
     ...
     if { $mem_option == "Automatic" } {
       ...
       #set temp_val [ expr { $num_filts * pow(2, [ fir_compiler_v3_2_v2_0_utils::log2ceil  $coef_mem_space  ]) } ]
       set temp_val [ expr { $num_filts * $coef_mem_space } ]
       set cmp_depth [ expr { pow(2,[ fir_compiler_v3_2_v2_0_utils::log2ceil  $temp_val   ] ) } ]
       if { $coef_reload == true } {
