...
public class DeckHandler implements MouseListener{
	...
	public void mouseClicked(MouseEvent e) {
		if(Game.players.get(0).isTurn()){
			this.refreshPanel(Game.players.get(0).playerCardsPanel, ((DeckPanel)e.getSource()).getDeck().get(((DeckPanel)e.getSource()).getDeck().size()-1),Game.players.get(0));
		}
		else if (Game.players.get(1).isTurn()){
			this.refreshPanel(Game.players.get(1).playerCardsPanel, ((DeckPanel)e.getSource()).getDeck().get(((DeckPanel)e.getSource()).getDeck().size()-1),Game.players.get(1));
		}
		else if (Game.players.get(2).isTurn()){
			this.refreshPanel(Game.players.get(2).playerCardsPanel, ((DeckPanel)e.getSource()).getDeck().get(((DeckPanel)e.getSource()).getDeck().size()-1),Game.players.get(2));
		}
		else if (Game.players.get(3).isTurn()){
			this.refreshPanel(Game.players.get(3).playerCardsPanel, ((DeckPanel)e.getSource()).getDeck().get(((DeckPanel)e.getSource()).getDeck().size()-1),Game.players.get(3));
		}
