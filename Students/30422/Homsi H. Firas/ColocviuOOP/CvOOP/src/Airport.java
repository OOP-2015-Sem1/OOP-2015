...
public class Airport {
	...
	public static void main(String[] args){
		...
		compartment1.addCargo(cargo1);
		
		compartment2.addPerson(passenger1);
		compartment2.addPerson(passenger3);
		compartment3.addPerson(passenger2);
...
class planeSortedByProfit implements Comparator<Plane>{
	...
	@Override
	public int compare(Plane p1, Plane p2) {
		if(p1.getPlaneProfit() < p2.getPlaneProfit())
			return 1;
		else 
			return -1;
	}
