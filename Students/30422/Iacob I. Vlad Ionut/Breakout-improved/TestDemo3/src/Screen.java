...
public class Screen extends JPanel implements Runnable {
	...
	private void createGameComponents() {
		...
		NewGameButton.setIcon(new ImageIcon(getClass().getResource("/Resources/play.png")));
		ChangeColorsButton.setBackground(Color.YELLOW);
		ChangeColorsButton.setIcon(new ImageIcon(getClass().getResource("/Resources/theme.png")));
