...
public class BoardPanel extends JPanel implements MouseListener, MouseMotionListener,DrawTile {
	...
	public void paintComponent(Graphics g) {
		...
		game.startGame(); 
		redrawMap(g);
		randPanel.redrawRandomPiece(g);
		randPanel.redrawScore(g);
