...
public class RandomRectangle extends JPanel {
	...
	public static int getRandomInt(int previousRandom){ 
		...
		while(randomNum == previousRandom) //avoiding text & background having the same color
											//we call it with -1 when we don't need to check that
