...
import com.example.alexh.zoosome.models.employees.Caretaker;
import com.example.alexh.zoosome.models.employees.Employee;
import com.example.alexh.zoosome.services.factories.Constants;
import com.example.alexh.zoosome.services.factories.employees.EmployeeFactory;
import com.example.alexh.zoosome.services.factories.employees.HumanFactory;
...
public class BigFactory {
    ...
    public Animal generateRandomAnimal(int speciesCode) {
        int typeCode = (int) (Math.random() * Constants.Animals.SPECIES_NAME[speciesCode].length);
        String type = Constants.Animals.SPECIES_NAME[speciesCode][typeCode];
