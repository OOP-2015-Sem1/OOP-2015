...
//public class EmployeeRepository extends EntityRepository<javasmmr.zoowsome.models.employees.Employee> {
	...
	protected javasmmr.zoowsome.models.employees.Employee getEntityFromXmlElement(Element element) throws Exception {
		String discriminant = element.getElementsByTagName(Constants.XML_TAGS.DISCRIMINANT).item(0).getTextContent();
		switch (discriminant) {
		case Constants.Employees.Employee.Caretaker:
			EmployeeAbstractFactory caretakers = new CaretakerFactory();
			javasmmr.zoowsome.models.employees.Employee caretaker = (Caretaker) caretakers.getEmployee(Constants.Employees.Employee.Caretaker);
